export const dict = {
  ...
  "command.terminal.new": "New Qwen terminal",
  "command.terminal.new.description": "Create a new Qwen terminal tab",
  ...
  "prompt.toast.modelAgentRequired.title": "Select a mode and model",
  "prompt.toast.modelAgentRequired.description": "Choose a mode and model before sending a prompt.",
  ...
  "settings.shortcuts.group.modelAndAgent": "Model and mode",
  ...
  "settings.agents.title": "Modes",
  "settings.agents.description": "Mode settings will be configurable here.",
